...
<div data-tid="sketch-player" class="bg-red-200" data-playerstate={playerState}>
            ...
            {#await createSketch( module )}
                ...
                <div class="sketch-poster-wrapper flex justify-center">
                    {#if (meta && meta.posterUrl)}
                        <div data-tid="sketch-poster" class="aspect-video">
                ...
                <div data-tid="sketch-loading" class="z-20 absolute inset-0 flex justify-center items-center bg-black/10">
            ...
            {:then sketch}
                <div class="sketch-wrapper">
                    ...
                    <div class="sketch-controls z-30 absolute inset-0 flex justify-center items-center group">
                        {#if [ PS_PAUSED ].includes( playerState ) }
                            <button data-tid="sketch-play-btn" class="btn btn-circle btn-outline text-black hover:bg-pink-400" on:click={onClickPlay}>
                        ...
                        {#if [ PS_PLAYING ].includes( playerState ) }
                            <button data-tid="sketch-pause-btn" class="btn btn-circle btn-outline text-black hover:bg-pink-400 hover:visible" on:click={onClickPause}>
                        ...
                        {#if [ PS_ENDED ].includes( playerState )}
                            <button data-tid="sketch-replay-btn" class="btn btn-circle btn-outline text-black hover:bg-pink-400" on:click={onClickReplay}>
